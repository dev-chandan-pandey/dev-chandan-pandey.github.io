    ...
    <Nav id="nav-menu">
      <NavbarContainer>
        <NavLogo to="/">
          ...
          >
            <DiCssdeck size="3rem" />{" "}
            <Span className="nav-link home">Portfolio</Span>
          </a>
        </NavLogo>
        <MobileIcon>
          <FaBars
        ...
        <NavItems>
          <NavLink href="#about" className="nav-link about">
            About
          </NavLink>
          <NavLink href="#skills" className="nav-link skills">
            Skills
          </NavLink>
          <NavLink href="#projects" className="nav-link projects">
            Projects
          </NavLink>
          <NavLink href="#statistics">Statistics</NavLink>
          <NavLink href="#education" className="nav-link education">
            Education
          </NavLink>
          <NavLink href="#contact" className="nav-link contact">
            Contact
          </NavLink>
        </NavItems>
        <ButtonContainer>
          <CheckResumeNav
            ...
            onClick={() => {
              window.open(
                ...
                'https://drive.google.com/drive/folders/1mqQ3lZNgTPzsygvjDnM8yWgAvmPyFBXu?usp=sharing',
                "_blank"
              );
            }}
            download={true}
